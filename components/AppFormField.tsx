...
export type FormFieldType = typeof FormFields[keyof typeof FormFields];
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className="flex-1">
          {props.fieldType !== FormFields.CHECKBOX && label && (
